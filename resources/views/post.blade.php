      ...
      <div class="row d-flex align-items-center flex-wrap">
        ...
        <div class="col-md-5">
          <ul class="breadcrumb d-flex justify-content-end">
            ...
            <li class="breadcrumb-item active">捐贈總覽</li>
          </ul>
        </div>
        @else
        <div class="col-md-7">
        ...
        <div class="col-md-5">
          <ul class="breadcrumb d-flex justify-content-end">
            <li class="breadcrumb-item"><a href="{{route('home')}}">主頁</a></li>
            <li class="breadcrumb-item active">徵求總覽</li>
          </ul>
        </div>
        @endif
      </div>
      ...
      <div class="row bar">
        <div id="blog-listing-medium" class="col-md-9">
          ...
          <section class="post">
            <div class="row">
              <div class="col-md-4">
                <div class="image"><a href="{{ route('post_info', ['id' => $post ]) }}"><img  src=" {{ asset($post->post_photo) }} " alt="Example blog post alt" class="img-fluid"></a></div>
              </div>
              <div class="col-md-8">
